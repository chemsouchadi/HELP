...
<body>
    <div class="nevbar" id="nevbar">
        ...
        <div class="menu" id="menu">
            <ul>
                ...
                <li><a href="donat_historique.php">donation historique</a></li>
                <li><a id="about" href="" target="blank">About me</a></li>
                <li><a id="donate" href="donations.php" target="blank">Donate</a></li>
            </ul>
        </div>
        <div class="menuicon">
    ...
    <div class="cover">
        ...
        <div class="information">
            ...
            <a href="donations.php" target="blank"><button>DONATE</button></a>
        </div>
    ...
    <div class="about">
        ...
        <div class="aboutcontent">
            ...
            <a href="donations.php" target="black">DONATE</a>
            <br>
            <br>
            <h5>_</h5>
